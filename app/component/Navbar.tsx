...
//                 <div
//                     className={`overflow-hidden transition-all duration-300 ease-in-out md:hidden ${isOpen ? "max-h-60 opacity-100" : "max-h-0 opacity-0"
//                         }`}
//                 >
...
//                                 className="body16 text-[var(--neutral-deep-black)] transition-colors"
//                             >
//                                 {link.label}
//                             </Link>
//                         ))}
